...
func runLauncher(ctx context.Context, cancel func(), opts *launcher.Options) error {
	...
	if opts.ControlServerURL == "" {
		...
		runner = desktopRunner.New(
			...
			desktopRunner.WithProcessSpawningEnabled(opts.KolideServerURL == "k2device-preprod.kolide.com" || opts.KolideServerURL == "localhost:3000" || opts.KolideServerURL == "localhost:3443" || strings.HasSuffix(opts.KolideServerURL, "herokuapp.com")),
