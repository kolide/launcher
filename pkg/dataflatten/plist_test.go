	...
	var tests = []flattenTestCase{
		{
			...
			out: []Row{
				Row{Path: []string{"inbinary", "astring"}, Value: "hello"},
				Row{Path: []string{"inbinary", "arr", "0"}, Value: "one"},
				Row{Path: []string{"inbinary", "arr", "1"}, Value: "two"},
				Row{Path: []string{"inxml", "arr", "0"}, Value: "one"},
				Row{Path: []string{"inxml", "arr", "1"}, Value: "two"},
				Row{Path: []string{"inxml", "astring"}, Value: "hello"},
			},
		},
		{
		...
		},
		{
			...
			out: []Row{
				Row{Path: []string{"inbinary"}, Value: "YnBsaXN0MDDSAQIDBlNhcnJXYXN0cmluZ6IEBVNvbmVTdHdvVWhlbGxvCA0RGRwgJAAAAAAAAAEBAAAAAAAAAAcAAAAAAAAAAAAAAAAAAAAq"},
				Row{Path: []string{"inxml"}, Value: "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<!DOCTYPE plist PUBLIC \"-//Apple//DTD PLIST 1.0//EN\" \"http://www.apple.com/DTDs/PropertyList-1.0.dtd\">\n<plist version=\"1.0\">\n<dict>\n\t<key>arr</key>\n\t<array>\n\t\t<string>one</string>\n\t\t<string>two</string>\n\t</array>\n\t<key>astring</key>\n\t<string>hello</string>\n</dict>\n</plist>"},
			},
		},
	}
