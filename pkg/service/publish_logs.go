...
func decodeJSONRPCLogCollection(_ context.Context, msg json.RawMessage) (any, error) {
...
func encodeJSONRPCPublishLogsResponse(_ context.Context, obj any) (json.RawMessage, error) {
