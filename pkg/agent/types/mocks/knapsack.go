...
// DenylistedQueryAttemptsStore provides a mock function with given fields:
func (_m *Knapsack) DenylistedQueryAttemptsStore() types.GetterSetterDeleterIteratorUpdater {
	ret := _m.Called()
