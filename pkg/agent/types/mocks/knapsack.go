...
// DisableOsqueryHealthchecks provides a mock function with given fields:
func (_m *Knapsack) DisableOsqueryHealthchecks() bool {
	ret := _m.Called()
...
// SetDisableOsqueryHealthchecks provides a mock function with given fields: enabled
func (_m *Knapsack) SetDisableOsqueryHealthchecks(enabled bool) error {
	ret := _m.Called(enabled)
