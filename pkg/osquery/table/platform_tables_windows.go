...
import (
	...
	"github.com/kolide/launcher/pkg/osquery/tables/windowsupdate"
...
func platformTables(client *osquery.ExtensionManagerClient, logger log.Logger, currentOsquerydBinaryPath string) []*table.Plugin {
	return []*table.Plugin{
		...
		windowsupdate.TablePlugin(windowsupdate.UpdatesTable, client, logger),
		windowsupdate.TablePlugin(windowsupdate.HistoryTable, client, logger),
