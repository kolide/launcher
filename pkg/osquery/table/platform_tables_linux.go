...
import (
	...
	"github.com/kolide/launcher/v2/ee/tables/crowdstrike/falcon_kernel_check"
	"github.com/kolide/launcher/v2/ee/tables/crowdstrike/falconctl"
	"github.com/kolide/launcher/v2/ee/tables/cryptsetup"
	"github.com/kolide/launcher/v2/ee/tables/dataflattentable"
	"github.com/kolide/launcher/v2/ee/tables/execparsers/apt"
	"github.com/kolide/launcher/v2/ee/tables/execparsers/data_table"
	"github.com/kolide/launcher/v2/ee/tables/execparsers/dnf"
	"github.com/kolide/launcher/v2/ee/tables/execparsers/dpkg"
	flatpak_upgradeable "github.com/kolide/launcher/v2/ee/tables/execparsers/flatpak/remote_ls/upgradeable"
	...
	pacman_group "github.com/kolide/launcher/v2/ee/tables/execparsers/pacman/group"
	pacman_info "github.com/kolide/launcher/v2/ee/tables/execparsers/pacman/info"
	pacman_upgradeable "github.com/kolide/launcher/v2/ee/tables/execparsers/pacman/upgradeable"
	"github.com/kolide/launcher/v2/ee/tables/execparsers/repcli"
	"github.com/kolide/launcher/v2/ee/tables/execparsers/rpm"
	"github.com/kolide/launcher/v2/ee/tables/execparsers/simple_array"
	"github.com/kolide/launcher/v2/ee/tables/fscrypt_info"
	"github.com/kolide/launcher/v2/ee/tables/gsettings"
	brew_upgradeable "github.com/kolide/launcher/v2/ee/tables/homebrew"
	nix_env_upgradeable "github.com/kolide/launcher/v2/ee/tables/nix_env/upgradeable"
	"github.com/kolide/launcher/v2/ee/tables/secureboot"
	"github.com/kolide/launcher/v2/ee/tables/xfconf"
	"github.com/kolide/launcher/v2/ee/tables/xrdb"
