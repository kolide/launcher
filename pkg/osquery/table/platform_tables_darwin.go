...
import (
	...
	"github.com/kolide/launcher/ee/tables/execparsers/nixenv"
...
func platformSpecificTables(k types.Knapsack, slogger *slog.Logger, currentOsquerydBinaryPath string) []osquery.OsqueryPlugin {
	...
	return []osquery.OsqueryPlugin{
		...
		dataflattentable.NewExecAndParseTable(k, slogger, "kolide_nix_upgradeable", nixenv.Parser, allowedcmd.NixEnv, []string{"--query", "--installed", "-c", "--xml"}),
