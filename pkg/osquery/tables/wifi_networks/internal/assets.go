...
// sources:
// internal/assets/get-networks.ps1 (1.218kB)
// internal/assets/nativewifi.cs (98.15kB)
...
var _internalAssetsGetNetworksPs1 = []byte(`function Get-Networks {
...
func internalAssetsGetNetworksPs1Bytes() ([]byte, error) {
	return _internalAssetsGetNetworksPs1, nil
}

func internalAssetsGetNetworksPs1() (*asset, error) {
	bytes, err := internalAssetsGetNetworksPs1Bytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "internal/assets/get-networks.ps1", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x4c, 0x26, 0x33, 0x68, 0x9d, 0xf5, 0x92, 0x6d, 0xc6, 0x2e, 0x2c, 0x73, 0xe9, 0x6e, 0x6f, 0x7e, 0x69, 0x97, 0xfb, 0x1b, 0xeb, 0x12, 0xe5, 0xb0, 0xf3, 0x44, 0xcc, 0xa3, 0x43, 0x60, 0xaa, 0xa4}}
	return a, nil
}

var _internalAssetsNativewifiCs = []byte(`using System;
...
func internalAssetsNativewifiCsBytes() ([]byte, error) {
	return _internalAssetsNativewifiCs, nil
}

func internalAssetsNativewifiCs() (*asset, error) {
	bytes, err := internalAssetsNativewifiCsBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "internal/assets/nativewifi.cs", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0xc0, 0x12, 0x16, 0x20, 0x79, 0xab, 0xfd, 0x8f, 0x14, 0x6e, 0x4f, 0xcc, 0x2b, 0xc9, 0x3c, 0x8b, 0x5, 0x25, 0xa1, 0xb8, 0xde, 0x46, 0xb1, 0xa, 0x58, 0xb0, 0xb5, 0x74, 0x9a, 0x64, 0x0, 0x8}}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	"internal/assets/get-networks.ps1": internalAssetsGetNetworksPs1,
	"internal/assets/nativewifi.cs":    internalAssetsNativewifiCs,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"internal": {nil, map[string]*bintree{
		"assets": {nil, map[string]*bintree{
			"get-networks.ps1": {internalAssetsGetNetworksPs1, map[string]*bintree{}},
			"nativewifi.cs": {internalAssetsNativewifiCs, map[string]*bintree{}},
		}},
	}},
}}
