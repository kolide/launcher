...
var _internalAssetsInstallerWxs = []byte(`<?xml version="1.0" encoding="UTF-8"?>
...
func internalAssetsInstallerWxsBytes() ([]byte, error) {
	return _internalAssetsInstallerWxs, nil
}
...
func internalAssetsInstallerWxs() (*asset, error) {
	...
	info := bindataFileInfo{name: "internal/assets/installer.wxs", size: 1558, mode: os.FileMode(420), modTime: time.Unix(1547607846, 0)}
