...
func sqliteData(ctx context.Context, slogger *slog.Logger, sourcePaths []string, comparer string, query string, queryContext table.QueryContext) ([]sourceData, error) {
