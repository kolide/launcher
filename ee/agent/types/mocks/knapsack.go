...
// CurrentEnrollmentStatus provides a mock function with given fields:
...
// SetInstanceRunner provides a mock function with given fields: r
func (_m *Knapsack) SetInstanceRunner(r types.OsqRunner) {
	_m.Called(r)
}
...
// SetRegistrationIDs provides a mock function with given fields: registrationIDs
func (_m *Knapsack) SetRegistrationIDs(registrationIDs []string) error {
	ret := _m.Called(registrationIDs)

	if len(ret) == 0 {
		panic("no return value specified for SetRegistrationIDs")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func([]string) error); ok {
		r0 = rf(registrationIDs)
	} else {
		r0 = ret.Error(0)
	}
