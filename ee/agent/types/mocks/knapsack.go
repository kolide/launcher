...
// DesktopRunnerServerURL provides a mock function with given fields:
func (_m *Knapsack) DesktopRunnerServerURL() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for DesktopRunnerServerURL")
	}
...
// SetDesktopRunnerServerURL provides a mock function with given fields: url
func (_m *Knapsack) SetDesktopRunnerServerURL(url string) error {
	ret := _m.Called(url)

	if len(ret) == 0 {
		panic("no return value specified for SetDesktopRunnerServerURL")
	}
