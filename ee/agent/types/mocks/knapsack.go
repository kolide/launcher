...
func (_m *Knapsack) AgentFlagsStore() types.KVStore {
	ret := _m.Called()
...
func (_m *Knapsack) AutoupdateErrorsStore() types.KVStore {
	ret := _m.Called()
...
func (_m *Knapsack) ConfigStore() types.KVStore {
	ret := _m.Called()
...
func (_m *Knapsack) ControlStore() types.KVStore {
	ret := _m.Called()
...
func (_m *Knapsack) InitialResultsStore() types.KVStore {
	ret := _m.Called()
...
func (_m *Knapsack) KatcConfigStore() types.KVStore {
	ret := _m.Called()
...
func (_m *Knapsack) OsqueryHistoryInstanceStore() types.KVStore {
	ret := _m.Called()
...
func (_m *Knapsack) PersistentHostDataStore() types.KVStore {
	ret := _m.Called()
...
func (_m *Knapsack) ResultLogsStore() types.KVStore {
	ret := _m.Called()
...
func (_m *Knapsack) SentNotificationsStore() types.KVStore {
	ret := _m.Called()
...
func (_m *Knapsack) ServerProvidedDataStore() types.KVStore {
	ret := _m.Called()
...
func (_m *Knapsack) StatusLogsStore() types.KVStore {
	ret := _m.Called()
...
func (_m *Knapsack) Stores() map[storage.Store]types.KVStore {
	ret := _m.Called()
	...
	if rf, ok := ret.Get(0).(func() map[storage.Store]types.KVStore); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_m *Knapsack) TokenStore() types.KVStore {
	ret := _m.Called()
