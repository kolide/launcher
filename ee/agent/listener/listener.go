...
func (l *launcherListener) handleEnrollmentRequest(e enrollmentRequest) error {
	...
	if err := tokenStore.Set(storage.KeyByIdentifier(storage.EnrollmentSecretTokenKey, storage.IdentifierTypeEnrollment, []byte(types.DefaultEnrollmentID)), []byte(e.EnrollmentSecret)); err != nil {
