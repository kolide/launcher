...
func TestEnroll(t *testing.T) {
	...
	storedToken, err := tokenStore.Get(storage.KeyByIdentifier(storage.EnrollmentSecretTokenKey, storage.IdentifierTypeRegistration, []byte(types.DefaultEnrollmentID)))
	require.NoError(t, err)
