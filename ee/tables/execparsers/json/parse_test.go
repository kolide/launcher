	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			case "lsblk data":
				...
				blockdevicesList, ok := blockdevices.([]any)
				...
				firstDevice, ok := blockdevicesList[0].(map[string]any)
				...
				firstChild, ok := childrenList[0].(map[string]any)
				...
				secondChild, ok := childrenList[1].(map[string]any)
				...
				thirdChild, ok := childrenList[2].(map[string]any)
				...
				secondDevice, ok := blockdevicesList[1].(map[string]any)
				...
				thirdDevice, ok := blockdevicesList[2].(map[string]any)
				...
				grandchildrenList, ok := grandchildren.([]any)
				...
				firstGrandchild, ok := grandchildrenList[0].(map[string]any)
			...
			case "nftables data":
				...
				metainfoItem, ok := nftablesList[0].(map[string]any)
				...
				metainfoMap, ok := metainfo.(map[string]any)
				...
				tableItem, ok := nftablesList[1].(map[string]any)
				...
				chainItem1, ok := nftablesList[2].(map[string]any)
				...
				chain1Map, ok := chain1.(map[string]any)
				...
				ruleItem1, ok := nftablesList[3].(map[string]any)
				...
				rule1Map, ok := rule1.(map[string]any)
				...
				firstExpr, ok := exprList[0].(map[string]any)
